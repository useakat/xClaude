...
- 日報の特記事項から重複なく箇条書きで整理
- 投稿の成果（高インプ・フォロワー増など）、note記事、ツール整備などを含める
- 1人称「僕」、箇条書き「・」
- NG: 過激・否定的・攻撃的・自慢（達成を素直に喜ぶのは適度にOK）

## ⑤ 来週やるべきタスク

- 前月報の「次月への改善」で挙げられた内容を月末までに達成するために、来週実行すべき具体的行動に落とし込む
- 月の残り週数を考慮して優先順位をつける
- 「1日2投稿」「水・土の定期ポスト投稿」のように行動レベルで書く
- 月報がない場合は日報から推論したタスクを書く
